...
def create_card(row):
    card = f"""
    <div style="border:1px solid #eee; border-radius:5px; padding:10px; margin:5px; width: 33.3%; height: 350px; overflow: auto; display:inline-block; vertical-align:top">
